  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden rounded-lg bg-shot">
        ...
        {product.image ? (
          <span className="on-dark pointer-events-none absolute bottom-2.5 left-2.5 rounded-pill border border-white/15 bg-[rgba(20,15,28,.75)] px-2.5 py-[5px] text-[9.5px] font-semibold tracking-[0.13em] text-ink uppercase">
            {c.stockTag}
          </span>
        ) : (
          <div
